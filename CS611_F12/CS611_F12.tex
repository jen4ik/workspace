...
The Algorithm: At each iteration, a number will be chosen to which other numbers
will added in an attempt to achive the sum of x
\vspace{0.5cm}\texttt{
\raggedright CheckElementsSum(sIndex, eIndex, element, x)\\
}
\vspace{0.5cm}\texttt{
\raggedright SumXOf2Elements(S,x)\\
\ \ MergeSort(S)
\ \ 
}
\vfill
